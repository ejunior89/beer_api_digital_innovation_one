...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "elio junior";
    private static final String CONTACT_GITHUB = "https://gtihub.com/ejunior89";
    private static final String CONTACT_EMAIL = "eliomaiajunior@gmail.com";
